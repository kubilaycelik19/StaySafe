"""
Django settings for staysafeapp project.
...
SECRET_KEY = 'django-insecure-n4q(gj0ej0kq75n08uypt2hvhj$zt_=#y2kn+8*$nkfiqow&ju'
...
WSGI_APPLICATION = 'staysafeapp.wsgi.application'
